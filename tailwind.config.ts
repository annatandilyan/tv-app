		...
		extend: {
			colors: {
				...
				sidebar: {
					...
					expanded: 'hsl(var(--sidebar-background-expanded))',
				...
				stream: {
					...
					'info-button': 'hsl(var(--info-button))',
					'overlay-dark': 'hsl(var(--overlay-dark))',
					'blue-primary': '#0F49FF',
					'blue-secondary': '#0019B7',
					'blue-hover-primary': '#2A5BFF',
					'blue-hover-secondary': '#0024E0',
					'sidebar-active': '#3b486d'
				}
			},
			borderRadius: {
				lg: 'var(--radius)',
